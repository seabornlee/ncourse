...
下面我们再来聊聊，为何代币是可以全球流通的。一般我们把公链原生的币，类似比特币，叫做 coin 。但是发币除了可以发 coin 还可以发 token ，也就是我们通常所说的代币或者叫通证。Token 不是区块链原生的，是通过区块链上的智能合约来发行的。比如我是一个小公司，只需要花上几百块钱找人帮我写几行智能合约代码，就可以发行我的某种币了，比如叫天堂币。实际情况是这样，如果有一个超级大公司也发行了某种币，但如果这个币是通过公司自己的数据库来发行的，那这个币的数据就有有可能被篡改，所以这个公司再强，币也不能在全社会流通。但是天堂币基于的是区块链，是公信数据，天堂币的各项数据，不管是发行总量还是交易记录，都是全球可见可验证的，任何人不能篡改的，所以才可以全球流通。
